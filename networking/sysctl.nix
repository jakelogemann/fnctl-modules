{ config, lib, pkgs, ... }: 
{ config = lib.mkIf (with config.fnctl2; enable && networking.tunePerformance) {
  boot.kernel.sysctl = {
    ...
    "net.core.netdev_budget"        = 1500;  # Default: 300
    ...
    "net.ipv4.tcp_max_syn_backlog" = 8192; # Default: 512
    "net.ipv4.tcp_syncookies"      = 1;    # Helps when limit is reached.
