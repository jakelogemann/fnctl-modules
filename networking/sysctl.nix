...
let isEnabled = with config.fnctl2; (enable && networking.tunePerformance); in { 
  config.boot.kernel.sysctl = mkIf isEnabled {
    ...
    "net.ipv4.tcp_fastopen"  = mkDefault 3;  # Default: 1
    ...
    "net.ipv4.tcp_max_syn_backlog" = mkDefault 8192; # Default: 512
    "net.ipv4.tcp_syncookies"      = mkDefault 1;    # Helps when limit is reached.
